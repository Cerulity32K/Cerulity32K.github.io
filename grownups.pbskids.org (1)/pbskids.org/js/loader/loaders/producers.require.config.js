(function( require ){
  ...
  require.config( function(){
    ...
    var faye_root     = href.match(/chip\.pbskids\.org/) ? 'http://chip.pbskids.org:8080/faye/' : (href.match(/super-vision-dev\.pbskids\.org/) ? 'http://super-vision-dev.pbskids.org:9000/faye/' : 'https://cms-tc.pbskids.org/supervisiontortuga/resources/js/faye-');
